  ...
  return (
    <header className="flex justify-between items-center w-full px-4 md:px-12 h-20 border-b border-[#e6beb2] bg-transparent">
      ...
      <div className="flex items-center gap-4">
        <button
          className="hidden md:flex items-center gap-2 bg-white border border-[#e6beb2] text-[#5c4037] px-6 py-2 text-[14px] font-semibold rounded-lg shadow-sm hover:bg-[#fff8f5] active:scale-95 transition-all"
